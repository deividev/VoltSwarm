...
- **Foundation de audio — GRAN AVANCE 2026-07-18:** estilo de SFX y música ENCONTRADO y validado in-game (ver "Estado del audio"); quedan los 10 hooks mudos, consolidar camas de música y el catálogo completo (Fase 5). QoL del mismo día: pausa muestra RIG+stats, números XP/oro acumuladores anclados al player, sliders con valor visible, click de UI universal.
