...
- **Sustain Cores**: Nanobot Swarm muestra y restaura 12/24/36/48/60 HP/min por tier. Hull Plates conserva sus valores de Max HP y no aporta una cura propia; la hoja de stats muestra el Max HP total actual. Leech Coil otorga 0.1/0.5/1/1.5/2% de probabilidad de restaurar exactamente 1 HP al acertar, con un cooldown global de 1 segundo.
