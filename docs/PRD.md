...
- **Sustain Cores**: Nanobot Swarm muestra y restaura 12/24/36/48/60 HP/min por tier. Hull Plates conserva sus valores de Max HP y no aporta una cura propia; la hoja de stats muestra el Max HP total actual. Leech Coil otorga 2/3/4/7/10% de probabilidad de restaurar 1 HP al acertar, con un cooldown global de 1 segundo.
