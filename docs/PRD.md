...
- **Sustain Cores**: Nanobot Swarm restaura `2/6, 4/6, 6/6, 8/6, 10/6` HP cada 10 s y muestra `2/4/6/8/10 HP/min` por tier. Cada copia suma su magnitud a la regeneración acumulada. Hull Plates conserva sus valores de Max HP: no modifica el HP actual ni activa Field Repair. Field Repair cura 1% del HP máximo tras instalar o subir cualquier otro Core durante gameplay. La hoja de stats muestra el Max HP total actual. Leech Coil otorga 0.1/0.5/1/1.5/2% de probabilidad de restaurar exactamente 1 HP al acertar, con un cooldown global de 1 segundo.
