...
**v1 usa 2 mapas:** Mapa 1 (fábrica abandonada/desguace) + Mapa 2 (megafábrica futurista activa y boss final). **Actualizado 2026-08-22:** el Mapa 2 ya tiene textura raster cenital final, props voxel finales, cobertura, cielo/niebla propios y arena base con muro. Su elenco propio cuenta con cuatro diseños aprobados —Furnace Mite, Forge Dart, Slagcaster y Axle Runner— documentados en `FOUNDRY_ENEMY_ROSTER.md`. **Furnace Mite está integrado y validado en 0.23.0** como sustitución visual de Voltling exclusiva de Foundry. **Axle Runner está aprobado, integrado y validado con 400+** como sustitución visual permanente de Sparkrunner en Mapa 2. Forge Dart y Slagcaster siguen pendientes de hojas finales e implementación. Rustbrute y Drone siguen sin sustituto aprobado. También permanece abierta la **pasada ambiental** de resplandor de colada y chispas. Una arena reactiva/modular queda como mejora opcional. Ciudad neón/estación orbital conserva su historia como dirección futura, no se borra ni se reetiqueta retroactivamente.
...
- **Pendiente:** pasada ambiental (2.5 de `PLAN_MAPA2.md`) y completar el elenco propio. Furnace Mite y Axle Runner ya están cerrados en runtime; Forge Dart y Slagcaster esperan hojas finales. Rustbrute y Drone no tienen sustituto. La arena base, el muro, cielo y niebla por mapa ya están implementados.
