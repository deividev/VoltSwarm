...
**Drone v2 (2026-08-21) sustituye esa excepción histórica:** su nuevo fuselaje central y los pods laterales físicamente unidos ya no dependen de una barra de rotor fina. Las hojas `ref-drone-front-v2.png`, `ref-drone-side-v2.png` y `ref-drone-back-v2.png` alimentan `sideProfileRef`, `sidePaint` y `backPaintRef` a 21 columnas. El preview multiángulo mide 1.238 voxels / 2.032 triángulos por instancia.
...
- **Drone v2** ✅ (`ref-drone-front-v2.png`, `ref-drone-side-v2.png`, `ref-drone-back-v2.png`): compact wide flyer with a central shield-like fuselage, physically attached ducted-fan pods, broad top armour and amber front visor — pink #ff9de2 / dark / amber. Runtime uses measured side depth + side/back paint at 21 columns.
